...
<body class="bg-gray-100">
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-green-700 text-white p-6 space-y-4">
            ...
            <nav class="space-y-2">
                <a href="{{ route('admin.dashboard') }}" class="block hover:underline">
                    Dashboard
                </a>

                <a href="{{ route('admin.cours.index') }}" class="block hover:underline">
                    Cours
                </a>

                <a href="{{ route('admin.publications.index') }}" class="block hover:underline">
                    Publications
                </a>
